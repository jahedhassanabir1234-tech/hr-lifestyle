...
const BundleProducts = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const { data } = await api.get("/bundle-products");
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8 font-poppins">Bundle Products</h1>
      ...
      {loading ? (
        ...
        <div className="text-center py-20">
          <p className="text-gray-500 text-lg font-poppins">No bundle products available</p>
